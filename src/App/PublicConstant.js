...
const ROUTE = {
  ...
  ORIGIN_RESULT_NEW_MANAGE: { URL: '/origin_result_new_manage/:menuKey', URL_PREFIX: '/origin_result_new_manage', MENU_KEY: '4-9', PERMISSION: [ROLE.EMPLOYEE_ADMIN, ROLE.EMPLOYEE_ARCHIVE_MANAGER, ROLE.EMPLOYEE_ARCHIVER, ROLE.EMPLOYEE_ADVISE_MANAGER, ROLE.EMPLOYEE_ADVISER, ROLE.MEMBER_1, ROLE.MEMBER_2, ROLE.MEMBER_3] },

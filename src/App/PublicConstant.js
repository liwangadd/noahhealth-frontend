...
const ROUTE = {
  ...
  HOME: {URL:'/home/:menuKey', URL_PREFIX:'/home', MENU_KEY: '1', PERMISSION: []},
    ...
    EXAM_RESULT_CLOSEUP: {URL:'/exam_result_closeup/:menuKey/:memberName/:detailId', URL_PREFIX:'/exam_result_closeup', MENU_KEY: '5', PERMISSION: [ROLE.EMPLOYEE_ARCHIVE_MANAGER, ROLE.EMPLOYEE_ARCHIVER]},
    ...
    HEALTH_RESULT_DETAIL: {URL:'/health_result_detail/:menuKey/:memberId/:memberName', URL_PREFIX:'/health_result_detail', MENU_KEY: '8', PERMISSION: [ROLE.EMPLOYEE_ADMIN, ROLE.EMPLOYEE_ADVISE_MANAGER, ROLE.EMPLOYEE_ADVISER, ROLE.MEMBER_2, ROLE.MEMBER_3]}
}

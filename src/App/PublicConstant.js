...
const ROUTE = {
  ...
  HOME: {URL:'/home/:menuKey', URL_PREFIX:'/home', MENU_KEY: '1', PERMISSION: []},
    ...
    MEMBER_DETAIL_MENZHEN_DOC: {URL:'/member_detail_menzhen_doc/:menuKey/:memberId/:memberName', URL_PREFIX:'/member_detail_menzhen_doc', MENU_KEY: '6', PERMISSION: [ROLE.EMPLOYEE_ADMIN, ROLE.EMPLOYEE_ADVISE_MANAGER, ROLE.EMPLOYEE_ADVISER, ROLE.MEMBER_1, ROLE.MEMBER_2, ROLE.MEMBER_3]},
    MEMBER_DETAIL_ZHUYUAN_DOC: {URL:'/member_detail_zhuyuan_doc/:menuKey/:memberId/:memberName', URL_PREFIX:'/member_detail_zhuyuan_doc', MENU_KEY: '6', PERMISSION: [ROLE.EMPLOYEE_ADMIN, ROLE.EMPLOYEE_ADVISE_MANAGER, ROLE.EMPLOYEE_ADVISER, ROLE.MEMBER_1, ROLE.MEMBER_2, ROLE.MEMBER_3]},
    MEMBER_DETAIL_TIJIAN_DOC: {URL:'/member_detail_tijian_doc/:menuKey/:memberId/:memberName', URL_PREFIX:'/member_detail_tijian_doc', MENU_KEY: '6', PERMISSION: [ROLE.EMPLOYEE_ADMIN, ROLE.EMPLOYEE_ADVISE_MANAGER, ROLE.EMPLOYEE_ADVISER, ROLE.MEMBER_1, ROLE.MEMBER_2, ROLE.MEMBER_3]},
    MEMBER_DETAIL_YINGXIANG_DOC: {URL:'/member_detail_yingxiang_doc/:menuKey/:memberId/:memberName', URL_PREFIX:'/member_detail_yingxiang_doc', MENU_KEY: '6', PERMISSION: [ROLE.EMPLOYEE_ADMIN, ROLE.EMPLOYEE_ADVISE_MANAGER, ROLE.EMPLOYEE_ADVISER, ROLE.MEMBER_1, ROLE.MEMBER_2, ROLE.MEMBER_3]},
    MEMBER_DETAIL_YAKE_DOC: {URL:'/member_detail_yake_doc/:menuKey/:memberId/:memberName', URL_PREFIX:'/member_detail_yake_doc', MENU_KEY: '6', PERMISSION: [ROLE.EMPLOYEE_ADMIN, ROLE.EMPLOYEE_ADVISE_MANAGER, ROLE.EMPLOYEE_ADVISER, ROLE.MEMBER_1, ROLE.MEMBER_2, ROLE.MEMBER_3]},
    MEMBER_DETAIL_ZHONGYI_DOC: {URL:'/member_detail_zhongyi_doc/:menuKey/:memberId/:memberName', URL_PREFIX:'/member_detail_zhongyi_doc', MENU_KEY: '6', PERMISSION: [ROLE.EMPLOYEE_ADMIN, ROLE.EMPLOYEE_ADVISE_MANAGER, ROLE.EMPLOYEE_ADVISER, ROLE.MEMBER_1, ROLE.MEMBER_2, ROLE.MEMBER_3]},
    MEMBER_DETAIL_XINLI_DOC: {URL:'/member_detail_xinli_doc/:menuKey/:memberId/:memberName', URL_PREFIX:'/member_detail_xinli_doc', MENU_KEY: '6', PERMISSION: [ROLE.EMPLOYEE_ADMIN, ROLE.EMPLOYEE_ADVISE_MANAGER, ROLE.EMPLOYEE_ADVISER, ROLE.MEMBER_1, ROLE.MEMBER_2, ROLE.MEMBER_3]},
    MEMBER_DETAIL_QITA_DOC: {URL:'/member_detail_qita_doc/:menuKey/:memberId/:memberName', URL_PREFIX:'/member_detail_qita_doc', MENU_KEY: '6', PERMISSION: [ROLE.EMPLOYEE_ADMIN, ROLE.EMPLOYEE_ADVISE_MANAGER, ROLE.EMPLOYEE_ADVISER, ROLE.MEMBER_1, ROLE.MEMBER_2, ROLE.MEMBER_3]},

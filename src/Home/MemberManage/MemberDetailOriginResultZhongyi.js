...
class MemberDetailOriginResultZhongyi extends React.Component {
        ...
        <BackTop visibilityHeight="200" />
        {
          isEmployee(role)
            ...
            <Breadcrumb className="category-path">
              ...
              <Breadcrumb.Item>中医资料</Breadcrumb.Item>
            </Breadcrumb>
            :
            <Breadcrumb className="category-path">
...
export default MemberDetailOriginResultZhongyi;

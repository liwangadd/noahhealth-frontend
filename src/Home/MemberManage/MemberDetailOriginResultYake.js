...
class MemberDetailOriginResultYake extends React.Component {
        ...
        <BackTop visibilityHeight="200" />
        {
          isEmployee(role)
            ...
            <Breadcrumb className="category-path">
              ...
              <Breadcrumb.Item>牙科资料</Breadcrumb.Item>
            </Breadcrumb>
            :
            <Breadcrumb className="category-path">
...
export default MemberDetailOriginResultYake;

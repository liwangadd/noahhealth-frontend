...
class MemberDetailOriginResultYingxiang extends React.Component {
        ...
        <BackTop visibilityHeight="200" />
        {
          isEmployee(role)
            ...
            <Breadcrumb className="category-path">
              ...
              <Breadcrumb.Item>门诊医技</Breadcrumb.Item>
            </Breadcrumb>
            :
            <Breadcrumb className="category-path">
...
export default MemberDetailOriginResultYingxiang;

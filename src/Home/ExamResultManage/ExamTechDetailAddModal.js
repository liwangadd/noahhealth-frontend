...
//添加原始资料表单
class ExamTechDetailAddModal_ extends React.Component {
...
const ExamTechDetailAddModal = Form.create()(ExamTechDetailAddModal_);
export default ExamTechDetailAddModal;

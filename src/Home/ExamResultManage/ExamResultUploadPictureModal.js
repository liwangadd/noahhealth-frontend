import './../OriginResultManage/OriginResultManage.css';
...
class OriginResultUploadPictureModal_ extends React.Component {
  ...
  render() {
    ...
    return (
        <Modal title="上传扫描件" visible={this.props.visible} onCancel={this.props.onCancel} footer={null}>
          <Upload name="file"
                  action= {SERVER + "/api/input/upload" }
                  data = {{id: this.props.inputResultId}}

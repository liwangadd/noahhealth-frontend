...
//添加原始资料表单
class ExamAssayDetailAddModal_ extends React.Component {
    ...
    return (
      <Modal title="添加检查记录" visible={this.props.visible} onOk={this.props.onConfirm} confirmLoading={this.props.confirmLoading} onCancel={this.props.onCancel}>
        <Form className="add-form">
          ...
          <FormItem {...formItemLayout} label="检查亚类" hasFeedback={true}>
...
const ExamAssayDetailAddModal = Form.create()(ExamAssayDetailAddModal_);
export default ExamAssayDetailAddModal;

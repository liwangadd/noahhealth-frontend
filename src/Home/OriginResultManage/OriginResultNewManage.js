  ...
  requestMembersUnderEmployee = () => {
    ...
    $.ajax({
      ...
      success: (result) => {
        ...
        this.refs.uploadForm.setFieldsValue({
  ...
  render() {
    ...
    return (
      <div>
        ...
        {
          (role === ROLE.EMPLOYEE_ARCHIVER || role === ROLE.EMPLOYEE_ARCHIVE_MANAGER || role === ROLE.EMPLOYEE_ADMIN) ?
            <Row>
              <Col span={24} style={{ textAlign: 'right' }}>
                <Button type="primary" onClick={this.showUploadModal}>添加健康档案</Button>
              </Col>
            </Row>
            : null
        }
